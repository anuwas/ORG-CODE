 ...
 *         &lt;element name="wsfaceFeeType" type="{https://ssl.selectpayment.com/PV}WSFaceFeeType"/>
...
@XmlRootElement(name = "GetHistoricalEventWithTransactionDetailReport")
public class GetHistoricalEventWithTransactionDetailReport {
    ...
    @XmlElement(required = true)
    @XmlSchemaType(name = "string")
    protected WSFaceFeeType wsfaceFeeType;
    @XmlElement(required = true)
    ...
    /**
     * Gets the value of the wsfaceFeeType property.
     * 
     * @return
     *     possible object is
     *     {@link WSFaceFeeType }
     *     
     */
    public WSFaceFeeType getWsfaceFeeType() {
        return wsfaceFeeType;
    }

    /**
     * Sets the value of the wsfaceFeeType property.
     * 
     * @param value
     *     allowed object is
     *     {@link WSFaceFeeType }
     *     
     */
    public void setWsfaceFeeType(WSFaceFeeType value) {
        this.wsfaceFeeType = value;
    }
