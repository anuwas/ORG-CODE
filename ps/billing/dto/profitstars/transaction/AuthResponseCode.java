...
/**
 * <p>Java class for AuthResponseCode.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="AuthResponseCode">
...
public enum AuthResponseCode {
    ...
    public static AuthResponseCode fromValue(String v) {
        for (AuthResponseCode c: AuthResponseCode.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
